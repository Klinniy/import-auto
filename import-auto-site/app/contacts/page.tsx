    ...
    <>
      ...
      >
        ...
        <InfoCard title="Важно">
          <p>
            На сайте сейчас не публикуются офисный адрес и юридические реквизиты, потому что подтверждённых данных для этих полей в проекте нет. Мы не добавляем их в интерфейс до фактического подтверждения.
          </p>
        </InfoCard>
      </PublicInfoShell>
    </>
